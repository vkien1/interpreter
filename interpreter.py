...
"""
In this interpreter, we have implemented the following grammar: 
addition and subtraction have higher precedence than multiplication and division
parentheses have the highest priority, allowing for custom grouping of operations
"""
...
# Main loop to handle user input and evaluate expressions
while True:
    code = input("Enter an expression to evaluate (or 'quit' to exit): ")
    if code.lower() == 'quit':
    ...
    try:
        ...
        print(f"The result of the expression '{code}' is: {result}")
    except SyntaxError as e:
        print(f"Syntax error: {e}")  # Handle syntax errors
    except ZeroDivisionError:
        print("Error: Division by zero is not allowed.")  # Handle division by zero errors
